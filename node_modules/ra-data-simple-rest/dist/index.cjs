            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, httpClient("".concat(apiUrl, "/").concat(resource, "/").concat(encodeURIComponent(params.id)).concat(query), { signal: params === null || params === void 0 ? void 0 : params.signal })];
                    case 1:
                        json = (_a.sent()).json;
