...
var InfiniteListBase = function (_a) {
    var authLoading = _a.authLoading, loading = _a.loading, offline = _a.offline, error = _a.error, empty = _a.empty, children = _a.children, render = _a.render, props = __rest(_a, ["authLoading", "loading", "offline", "error", "empty", "children", "render"]);
