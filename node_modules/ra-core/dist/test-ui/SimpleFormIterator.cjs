...
var Translate_1 = require("../i18n/Translate.cjs");
var useFieldValue_1 = require("../util/useFieldValue.cjs");
var useWrappedSource_1 = require("../core/useWrappedSource.cjs");
var useArrayInput_1 = require("../controller/input/useArrayInput.cjs");
var useSimpleFormIterator_1 = require("../controller/input/useSimpleFormIterator.cjs");
var useSimpleFormIteratorItem_1 = require("../controller/input/useSimpleFormIteratorItem.cjs");
var SimpleFormIteratorBase_1 = require("../controller/input/SimpleFormIteratorBase.cjs");
var SimpleFormIteratorItemBase_1 = require("../controller/input/SimpleFormIteratorItemBase.cjs");
...
var DefaultAddItemButton = function (props) {
    var _a = (0, useSimpleFormIterator_1.useSimpleFormIterator)(), add = _a.add, source = _a.source;
    ...
    return (React.createElement("button", __assign({ type: "button", onClick: function () { return add(); }, className: ["button-add button-add-".concat(source), className].join(' ') }, rest),
        React.createElement(Translate_1.Translate, { i18nKey: "ra.action.add" }, "Add")));
};
var DefaultRemoveItemButton = function (props) {
    ...
    return (React.createElement("button", __assign({ type: "button", onClick: function () { return remove(); }, className: [
        ...
        React.createElement(Translate_1.Translate, { i18nKey: "ra.action.remove" }, "Remove")));
};
var DefaultReOrderButtons = function (_a) {
    ...
    return (React.createElement("span", { className: [
        ...
        React.createElement("button", { type: "button", onClick: function () { return reOrder(index - 1); }, disabled: index <= 0 },
            React.createElement(Translate_1.Translate, { i18nKey: "ra.action.move_up" }, "Move Up")),
        React.createElement("button", { type: "button", onClick: function () { return reOrder(index + 1); }, disabled: total == null || index >= total - 1 },
            React.createElement(Translate_1.Translate, { i18nKey: "ra.action.move_down" }, "Move Down"))));
};
exports.SimpleFormIteratorItem = React.forwardRef(function SimpleFormIteratorItem(props, ref) {
    ...
    return (React.createElement(SimpleFormIteratorItemBase_1.SimpleFormIteratorItemBase, __assign({}, props),
...
var SimpleFormIterator = function (props) {
    ...
    var _f = (0, useArrayInput_1.useArrayInput)(props), fields = _f.fields, remove = _f.remove;
    var translate = (0, useTranslate_1.useTranslate)();
    var handleArrayClear = (0, react_1.useCallback)(function () {
        remove();
        setConfirmIsOpen(false);
    }, [remove]);
    var records = (0, useFieldValue_1.useFieldValue)({ source: finalSource });
    var getArrayInputNewItemDefaults = (0, controller_1.useGetArrayInputNewItemDefaults)(fields);
    var getItemDefaults = (0, util_1.useEvent)(function (item) {
        if (item === void 0) { item = undefined; }
        if (item != null)
            return item;
        return getArrayInputNewItemDefaults(children);
    });
    return fields ? (React.createElement(SimpleFormIteratorBase_1.SimpleFormIteratorBase, __assign({ getItemDefaults: getItemDefaults }, props),
            ...
            !disabled &&
                ...
                fields.length > 0 &&
                    ...
                    React.createElement("button", { type: "button", onClick: function () {
                        ...
                        React.createElement(Translate_1.Translate, { i18nKey: "ra.action.clear_array_input" }, "Clear"))))))))) : null;
};
