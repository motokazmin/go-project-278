...
export var SimpleFormIteratorItem = React.forwardRef(function SimpleFormIteratorItem(props, ref) {
...
export var SimpleFormIterator = function (props) {
    ...
    var _f = useArrayInput(props), fields = _f.fields, remove = _f.remove;
    var translate = useTranslate();
    var handleArrayClear = useCallback(function () {
        remove();
        setConfirmIsOpen(false);
    }, [remove]);
    var records = useFieldValue({ source: finalSource });
    ...
    return fields ? (React.createElement(SimpleFormIteratorBase, __assign({ getItemDefaults: getItemDefaults }, props),
