...
var useNotificationContext_1 = require("../notification/useNotificationContext.cjs");
var CloseNotificationContext_1 = require("../notification/CloseNotificationContext.cjs");
var undoableEventEmitter_1 = __importDefault(require("../dataProvider/undoableEventEmitter.cjs"));
var useTakeUndoableMutation_1 = require("../dataProvider/undo/useTakeUndoableMutation.cjs");
/**
...
var Notification = function () {
    var _a = (0, useNotificationContext_1.useNotificationContext)(), notifications = _a.notifications, takeNotification = _a.takeNotification;
    var takeMutation = (0, useTakeUndoableMutation_1.useTakeUndoableMutation)();
    var _b = (0, react_1.useState)(false), open = _b[0], setOpen = _b[1];
    var _c = React.useState(undefined), currentNotification = _c[0], setCurrentNotification = _c[1];
    ...
    var handleExited = (0, react_1.useCallback)(function () {
        ...
        if (currentNotification &&
            ...
            if (mutation) {
                ...
                undoableEventEmitter_1.default.emit('end', { isUndo: false });
            }
        }
        setCurrentNotification(undefined);
    ...
    var handleUndo = (0, react_1.useCallback)(function () {
        ...
        if (mutation) {
            ...
            // FIXME kept for BC: remove in v6
            undoableEventEmitter_1.default.emit('end', { isUndo: true });
        }
        setOpen(false);
    }, [takeMutation]);
    var _d = currentNotification || {}, message = _d.message, notificationOptions = _d.notificationOptions;
    var _e = notificationOptions || {}, messageArgs = _e.messageArgs, undoable = _e.undoable;
    (0, react_1.useEffect)(function () {
        if (!undoable)
            return;
        var timer = setTimeout(function () {
            handleExited();
        }, (notificationOptions === null || notificationOptions === void 0 ? void 0 : notificationOptions.autoHideDuration) || 4000);
        return function () { return clearTimeout(timer); };
    }, [undoable, handleExited, notificationOptions]);
    if (!currentNotification)
        return null;
    return (React.createElement(CloseNotificationContext_1.CloseNotificationContext.Provider, { value: handleRequestClose },
