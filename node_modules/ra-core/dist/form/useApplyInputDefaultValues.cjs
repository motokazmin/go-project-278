...
var useApplyInputDefaultValues = function (_a) {
    ...
    var _b = (0, react_hook_form_1.useFormContext)(), getValues = _b.getValues, resetField = _b.resetField, reset = _b.reset, subscribe = _b.subscribe;
    var recordValue = (0, get_js_1.default)(record, finalSource);
    var formValue = (0, get_js_1.default)(getValues(), finalSource);
    var isDirty = (0, react_1.useRef)(undefined);
    (0, react_1.useEffect)(function () {
        return subscribe({
            ...
            callback: function (_a) {
                ...
                isDirty.current = (0, get_js_1.default)(dirtyFields !== null && dirtyFields !== void 0 ? dirtyFields : {}, finalSource, false);
            },
        });
