...
var useSimpleFormIteratorStyles_1 = require("./useSimpleFormIteratorStyles.cjs");
var RemoveItemButton_1 = require("./RemoveItemButton.cjs");
var ReOrderButtons_1 = require("./ReOrderButtons.cjs");
exports.SimpleFormIteratorItem = (0, react_1.memo)((0, react_1.forwardRef)(function SimpleFormIteratorItem(props, ref) {
    var children = props.children, disabled = props.disabled, disableReordering = props.disableReordering, disableRemove = props.disableRemove, getItemLabel = props.getItemLabel, index = props.index, inline = props.inline, _a = props.removeButton, removeButton = _a === void 0 ? React.createElement(RemoveItemButton_1.RemoveItemButton, null) : _a, _b = props.reOrderButtons, reOrderButtons = _b === void 0 ? React.createElement(ReOrderButtons_1.ReOrderButtons, null) : _b;
    ...
    var label = typeof getItemLabel === 'function'
        ? getItemLabel(index)
        : getItemLabel;
    return (React.createElement(ra_core_1.SimpleFormIteratorItemBase, __assign({}, props),
        React.createElement("li", { className: useSimpleFormIteratorStyles_1.SimpleFormIteratorClasses.line, ref: ref },
            ...
            React.createElement(material_1.Stack, { className: (0, clsx_1.default)(useSimpleFormIteratorStyles_1.SimpleFormIteratorClasses.form), direction: inline ? { xs: 'column', sm: 'row' } : 'column', sx: {
                    gap: inline ? 2 : 0,
                } }, children),
