...
export var FilterListItem = memo(function (inProps) {
    ...
    return (React.createElement(StyledListItem, __assign({ disablePadding: true, disableGutters: true, secondaryAction: isSelected ? (React.createElement(IconButton, { size: "small", onClick: function (event) {
