...
exports.FilterListItem = (0, react_1.memo)(function (inProps) {
    ...
    return (React.createElement(StyledListItem, __assign({ disablePadding: true, disableGutters: true, secondaryAction: isSelected ? (React.createElement(material_1.IconButton, { size: "small", onClick: function (event) {
                event.stopPropagation();
                handleClick();
            } },
            React.createElement(CancelOutlined_1.default, null))) : null }, rest),
        React.createElement(material_1.ListItemButton, { onClick: handleClick, selected: isSelected, className: exports.FilterListItemClasses.listItemButton },
