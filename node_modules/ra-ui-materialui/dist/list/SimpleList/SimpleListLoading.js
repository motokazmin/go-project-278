...
export var SimpleListLoading = function (inProps) {
    ...
    return oneSecondHasPassed ? (React.createElement(StyledList, __assign({ className: className }, rest), times(nbFakeLines, function (key) { return (React.createElement(ListItem, { key: key, secondaryAction: hasRightAvatarOrIcon ? React.createElement(Avatar, null, "\u00A0") : null },
        ...
        React.createElement(ListItemText, { primary: React.createElement("div", null,
                ...
                hasTertiaryText && (React.createElement("span", { className: SimpleListLoadingClasses.tertiary },
                    React.createElement(Placeholder, null)))), secondary: hasSecondaryText ? React.createElement(Placeholder, null) : undefined }))); }))) : null;
};
